...
Materi berlisensi [<i class="fab fa-creative-commons"></i> BY 4.0](https://creativecommons.org/licenses/by/4.0/). **Materi bebas digunakan kembali namun wajib menyebutkan sumber aslinya**. <br>

## Waktu dan tempat
*Workshop* diselenggarakan pada hari **Rabu, 4 September 2019**, pukul 08.00-16.00 WIB di Ruang Sidang I, Fakultas Psikologi Universitas Airlangga. <br>
...
* Peugh, James L. (2010). A practical guide to multilevel modeling. Journal of School Psychology, 48, 85-112. doi: [10.1016/j.jsp.2009.09.002](https://doi.org/10.1016/j.jsp.2009.09.002) <br>
...
Mohon untuk menyimak video petunjuk instalasi *module* GAMLj jamovi berikut ini. Gunakan [jamovi versi terbaru (1.1.2 untuk Windows, 1.1.3 untuk MacOS)](https://www.jamovi.org/downloads/jamovi-1.1.2.0-win64.exe).
