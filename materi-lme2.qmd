...
![](libs/scat-group.png){width="60%" fig-align="center"}
...
> Pengujian model menghasilkan kesimpulan bahwa model tepat menggambarkan data (_F_(1, 3) = 93, _p_ = .002), sehingga dapat disimpulkan bahwa tingkat pendapatan keluarga dan kemandirian anak, berkaitan secara berarti.
